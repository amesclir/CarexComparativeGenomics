...
#genome = cbind(c("LG1", "LG1", "LG1", "LG2", "LG2", "LG2", "LG3", "LG3", #"LG3"),c(1,1000,10000,1,1000,10000,1,1000,10000), NA, c("M1","M2","M3","M4","M5","M6","M7","M8","M9" ))
...
littledaleimodel <- fisfusmodelling(bowtie2, rearrangements,pfis)
...
maximum[i] <- max(littledaleimodel279[littledaleimodel279[,1]==unique(littledaleimodel279[,1])[i],2])
maximum

littledaleimodel279genome <- cbind(unique(littledaleimodel279[,1]),0,maximum, NA, NA)
colnames(littledaleimodel279genome) <- colnames(both)

genomesim <- rbind(both[1:29,],littledaleimodel279genome) 
...
linkssim <- merge(bowtie2, littledaleimodel279, by.x = "Marker", by.y = "Marker", sort = F)
linkssim <- linkssim[,c(2,3,4,5,6,7)]
linkssim

RCircos.Link.Plot(linkssim, track.num, TRUE)
