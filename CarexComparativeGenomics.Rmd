...
glm_genomeblocks_alld <- cbind(glm_genomeblocks_alld,genomeblocksTE_alld[genomeblocksTE_alld[,4] != "singlemarker", 5],genomeblocksgypsy_alld[genomeblocksgypsy_alld[,4] != "singlemarker", 5])
...
library(lme4)
glm_genomeblocks_alld<- data.frame (glm_genomeblocks_alld)
colnames(glm_genomeblocks_alld) <- c("chromosome", "type", "BCR",  "GC", "Genes", "TE", "gypsy")
fittedModel <- glmer (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(gypsy) + (1|chromosome), data = glm_genomeblocks_alld, family = binomial(link = "logit"))
summary(fittedModel)

fittedModel2 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(gypsy), family = binomial(link = "logit"), data = glm_genomeblocks_alld)
summary(fittedModel2)

fittedModel3 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE)+ as.numeric(gypsy), family = gaussian(link = "identity"), data = glm_genomeblocks_alld)
summary(fittedModel3)

fittedModel4 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes)+ as.numeric(TE) + as.numeric(gypsy), family = poisson(link = "log"), data = glm_genomeblocks_alld)
summary(fittedModel4)
...
glm_genomeblocks_alld <- cbind(glm_genomeblocks_alld,genomeblocksTE_alld[genomeblocksTE_alld[,4] != "singlemarker", 5],genomeblocksclass_II_alld[genomeblocksclass_II_alld[,4] != "singlemarker", 5])
...
library(lme4)
glm_genomeblocks_alld<- data.frame (glm_genomeblocks_alld)
colnames(glm_genomeblocks_alld) <- c("chromosome", "type", "BCR",  "GC", "Genes", "TE", "class_II")
fittedModel <- glmer (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(class_II) + (1|chromosome), data = glm_genomeblocks_alld, family = binomial(link = "logit"))
summary(fittedModel)

fittedModel2 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(class_II), family = binomial(link = "logit"), data = glm_genomeblocks_alld)
summary(fittedModel2)

fittedModel3 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE)+ as.numeric(class_II), family = gaussian(link = "identity"), data = glm_genomeblocks_alld)
summary(fittedModel3)

fittedModel4 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes)+ as.numeric(TE) + as.numeric(class_II), family = poisson(link = "log"), data = glm_genomeblocks_alld)
summary(fittedModel4)
...
glm_genomeblocks_alld <- cbind(glm_genomeblocks_alld,genomeblocksTE_alld[genomeblocksTE_alld[,4] != "singlemarker", 5],genomeblockscopia_alld[genomeblockscopia_alld[,4] != "singlemarker", 5])
...
library(lme4)
glm_genomeblocks_alld<- data.frame (glm_genomeblocks_alld)
colnames(glm_genomeblocks_alld) <- c("chromosome", "type", "BCR",  "GC", "Genes", "TE", "copia")
fittedModel <- glmer (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(copia) + (1|chromosome), data = glm_genomeblocks_alld, family = binomial(link = "logit"))
summary(fittedModel)

fittedModel2 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(copia), family = binomial(link = "logit"), data = glm_genomeblocks_alld)
summary(fittedModel2)

fittedModel3 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE)+ as.numeric(copia), family = gaussian(link = "identity"), data = glm_genomeblocks_alld)
summary(fittedModel3)

fittedModel4 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes)+ as.numeric(TE) + as.numeric(copia), family = poisson(link = "log"), data = glm_genomeblocks_alld)
summary(fittedModel4)
...
glm_genomeblocks_alld <- cbind(glm_genomeblocks_alld,genomeblocksTE_alld[genomeblocksTE_alld[,4] != "singlemarker", 5],genomeblocksnon_LTR_alld[genomeblocksnon_LTR_alld[,4] != "singlemarker", 5])
...
library(lme4)
glm_genomeblocks_alld<- data.frame (glm_genomeblocks_alld)
colnames(glm_genomeblocks_alld) <- c("chromosome", "type", "BCR",  "GC", "Genes", "TE", "non_LTR")
fittedModel <- glmer (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(non_LTR) + (1|chromosome), data = glm_genomeblocks_alld, family = binomial(link = "logit"))
summary(fittedModel)

fittedModel2 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE) + as.numeric(non_LTR), family = binomial(link = "logit"), data = glm_genomeblocks_alld)
summary(fittedModel2)

fittedModel3 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(TE)+ as.numeric(non_LTR), family = gaussian(link = "identity"), data = glm_genomeblocks_alld)
summary(fittedModel3)

fittedModel4 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes)+ as.numeric(TE) + as.numeric(non_LTR), family = poisson(link = "log"), data = glm_genomeblocks_alld)
summary(fittedModel4)
