...
#We have probably run the analysis without the start and ending of the chromosomes!!!
...
numberofconseved <- vector()
for (i in 1:100)
numberofconseved[i] <- dim(outblockdsimperm[[i]][outblockdsimperm[[i]][,4]=="conserved",])[1]
