...
fittedModel3 <- glm (as.numeric(type) ~ as.numeric(BCR) + as.numeric(GC) + as.numeric(Genes) + as.numeric(Genes), family = gaussian(link = "identity"), data = glm_genomeblocks_alld)
summary(fittedModel3)
