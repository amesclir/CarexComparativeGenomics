...
GCtemp2 <- rbind(GCtemp2, newrow)
}


  for (k in 1:dim(GCtemp2)[1])
out[i,6] <-   (sum(GCtemp2[k,3] * GCtemp2[k,4]) / (sum(GCtemp2[k,3])))
}
...
genomeblocksCR3_1dGC <- genomeblocksGC(genomeblocksBCR3_1d,chr1GC)
genomeblocksCR3_1dGC

chr2GC <- read.csv("./GCcontent/chr1GCcontent.csv")
genomeblocksCR3_2dGC <- genomeblocksGC(genomeblocksBCR3_2d,chr2GC)
genomeblocksCR3_2dGC
