...
boxplot(as.numeric(genomeblocksBCR3_alld[genomeblocksBCR3_alld[,4] != "singlemarker", 5]) ~ genomeblocksBCR3_alld[genomeblocksBCR3_alld[,4] != "singlemarker", 4])

anova(lm(as.numeric(genomeblocksBCR3_alld[genomeblocksBCR3_alld[,4] != "singlemarker", 5]) ~ genomeblocksBCR3_alld[genomeblocksBCR3_alld[,4] != "singlemarker", 4]))
summary(aov(as.numeric(genomeblocksBCR3_alld[genomeblocksBCR3_alld[,4] != "singlemarker", 5]) ~ genomeblocksBCR3_alld[genomeblocksBCR3_alld[,4] != "singlemarker", 4]))
...
mean(as.numeric(genomeblocksBCR3_alldGC[,6][genomeblocksBCR3_alldGC[,4] == "conserved"]))
mean(as.numeric(genomeblocksBCR3_alldGC[,6][genomeblocksBCR3_alldGC[,4] == "fisfus"]))
mean(as.numeric(genomeblocksBCR3_alldGC[,6][genomeblocksBCR3_alldGC[,4] == "singlemarker"]))

sd(as.numeric(genomeblocksBCR3_alldGC[,6][genomeblocksBCR3_alldGC[,4] == "conserved"]))
sd(as.numeric(genomeblocksBCR3_alldGC[,6][genomeblocksBCR3_alldGC[,4] == "fisfus"]))
sd(as.numeric(genomeblocksBCR3_alldGC[,6][genomeblocksBCR3_alldGC[,4] == "singlemarker"]))

genomeblocksBCR3_alldGC
genomeblocksBCR3_alldGC[genomeblocksBCR3_alld[,4] != "singlemarker", ]

boxplot(as.numeric(genomeblocksBCR3_alldGC[genomeblocksBCR3_alldGC[,4] != "singlemarker", 6]) ~ genomeblocksBCR3_alldGC[genomeblocksBCR3_alldGC[,4] != "singlemarker", 4])

anova(lm(as.numeric(genomeblocksBCR3_alldGC[genomeblocksBCR3_alldGC[,4] != "singlemarker", 6]) ~ genomeblocksBCR3_alldGC[genomeblocksBCR3_alldGC[,4] != "singlemarker", 4]))
summary(aov(as.numeric(genomeblocksBCR3_alldGC[genomeblocksBCR3_alldGC[,4] != "singlemarker", 6]) ~ genomeblocksBCR3_alldGC[genomeblocksBCR3_alldGC[,4] != "singlemarker", 4]))
...
mean(as.numeric(genomeblocksGenesalld[,7][genomeblocksGenesalld[,4] == "conserved"]))
mean(as.numeric(genomeblocksGenesalld[,7][genomeblocksGenesalld[,4] == "fisfus"]))
mean(as.numeric(genomeblocksGenesalld[,7][genomeblocksGenesalld[,4] == "singlemarker"]))

sd(as.numeric(genomeblocksGenesalld[,7][genomeblocksGenesalld[,4] == "conserved"]))
sd(as.numeric(genomeblocksGenesalld[,7][genomeblocksGenesalld[,4] == "fisfus"]))
sd(as.numeric(genomeblocksGenesalld[,7][genomeblocksGenesalld[,4] == "singlemarker"]))

genomeblocksGenesalld
genomeblocksGenesalld[genomeblocksBCR3_alld[,4] != "singlemarker", ]

boxplot(as.numeric(genomeblocksGenesalld[genomeblocksGenesalld[,4] != "singlemarker", 7]) ~ genomeblocksGenesalld[genomeblocksGenesalld[,4] != "singlemarker", 4])

anova(lm(as.numeric(genomeblocksGenesalld[genomeblocksGenesalld[,4] != "singlemarker", 7]) ~ genomeblocksGenesalld[genomeblocksGenesalld[,4] != "singlemarker", 4]))
summary(aov(as.numeric(genomeblocksGenesalld[genomeblocksGenesalld[,4] != "singlemarker", 7]) ~ genomeblocksGenesalld[genomeblocksGenesalld[,4] != "singlemarker", 4]))
